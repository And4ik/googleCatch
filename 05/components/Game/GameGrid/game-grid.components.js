...
import {Google} from "./Google/google.components.js";
import {Player} from "./Player/player.components.js";
...
export function GameGrid() {
    ...
    for (let y = 0; y < gridSize.y; y++) {
        ...
        for (let x = 0; x < gridSize.x; x++) {
          ...
          if (x === getPlayer1Coords().x
              && y === getPlayer1Coords().y) {
            cell.append(Player(1))
          }
          if (x === getPlayer2Coords().x
              && y === getPlayer2Coords().y) {
